...
export class ClearedAllTables1768247372417 implements MigrationInterface {
    name = 'ClearedAllTables1768247372417'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE \`transactions\` (
                ...
                \`disputeId\` varchar(255) NULL,
                \`reference\` varchar(255) NULL,
                \`accessCode\` varchar(255) NULL,
                \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
                \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
                \`disputesId\` varchar(36) NULL,
                INDEX \`IDX_da87c55b3bbbe96c6ed88ea7ee\` (\`status\`),
                INDEX \`IDX_e744417ceb0b530285c08f3865\` (\`createdAt\`),
                PRIMARY KEY (\`id\`)
            ) ENGINE = InnoDB
        `);
        await queryRunner.query(`
            CREATE TABLE \`message_attachments\` (
                ...
                INDEX \`IDX_7a3bd5b0efb4a44cc288a4dc70\` (\`publicId\`),
                PRIMARY KEY (\`id\`)
            ) ENGINE = InnoDB
        `);
        await queryRunner.query(`
            CREATE TABLE \`inboxes\` (
                ...
                \`receiverType\` enum ('admin', 'user', 'professional') NOT NULL,
                \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
                \`messageId\` varchar(36) NULL,
                INDEX \`IDX_e826d87cbe4a059e92bd67dc40\` (\`receiverId\`),
                INDEX \`IDX_fa060cd058e633ceee99a61875\` (\`receiverType\`),
                INDEX \`IDX_cda2ba168abbba06efc28e0459\` (\`receiverId\`, \`receiverType\`),
                PRIMARY KEY (\`id\`)
            ) ENGINE = InnoDB
        `);
        await queryRunner.query(`
            CREATE TABLE \`messages\` (
                ...
                \`senderType\` enum ('admin', 'user', 'professional') NOT NULL,
                \`receiverId\` varchar(255) NOT NULL,
                \`receiverType\` enum ('admin', 'user', 'professional') NOT NULL,
                \`content\` text NULL,
                \`type\` enum ('text', 'file') NOT NULL DEFAULT 'text',
                \`status\` enum ('failed', 'delivered', 'pending', 'read') NOT NULL DEFAULT 'pending',
                \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
                \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
                \`inboxId\` varchar(36) NULL,
                INDEX \`IDX_36bc604c820bb9adc4c75cd411\` (\`chatId\`),
                INDEX \`IDX_2db9cf2b3ca111742793f6c37c\` (\`senderId\`),
                INDEX \`IDX_33c3c7eac434c7430b391e9278\` (\`senderType\`),
                INDEX \`IDX_acf951a58e3b9611dd96ce8904\` (\`receiverId\`),
                INDEX \`IDX_5d4a65355782093d1f726d335c\` (\`receiverType\`),
